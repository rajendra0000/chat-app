...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (chatRepository.count() > 0) {
            log.info("Database already seeded with chats, skipping...");
            return;
        }
        ...
        documents.add(new Document(null, "doc-001", "local", "/files/report.pdf", "application/pdf", "report.pdf", null, null));
        documents.add(new Document(null, "doc-002", "local", "/files/photo.jpg", "image/jpeg", "photo.jpg", null, null));
        documents.add(new Document(null, "doc-003", "local", "/files/notes.txt", "text/plain", "notes.txt", null, null));
        documents.add(new Document(null, "doc-004", "local", "/files/presentation.pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation", "presentation.pptx", null, null));
        documents.add(new Document(null, "doc-005", "local", "/files/data.csv", "text/csv", "data.csv", null, null));
